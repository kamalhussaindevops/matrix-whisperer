...
Use the [Personal Matrix Calculator](/calculator) to check your own chart alongside the [Child Matrix Calculator](/child-matrix). Identify where your energies naturally support each other, and where your default styles create friction. Then make agreements — with yourself first, then with the child at an age-appropriate level.
